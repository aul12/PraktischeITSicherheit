...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \visible<1->{\item This extra enclave is an architectural enclave, called \glqq{}quoting enclave\grqq{}}
        \visible<2->{\item The quoting enclave verifies and transforms the enclave report into a quote}
        \visible<4->{\item A quote is signed by the quoting enclave by the Provisioning Key}
        \visible<3->{\item This quote is remotely verifiable}
    \end{itemize}
\end{frame}
